...
DocsDialog::DocsDialog(QWidget* parent)
    ...
    addSection(QStringLiteral("Tutorial"), sectionHtml(
        ...
        QStringLiteral(
            ...
            "toggles play/pause. The trigger position is flagged above the scrub line; red "
            "dots are your defect marks; the value row shows relative frame, time from "
            "trigger, and machine speed.</p>"
